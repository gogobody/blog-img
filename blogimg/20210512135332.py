...
bpath = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../cqhttp/'))+"/"
# print(bpath)
...
def _start_cqhttp(cqhttp_file_name):
    ...
    # print(bpath)
    logger.info("go-cqhttp filename：{}".format(cqhttp_path))
    subprocess.Popen([f'./{bpath}', 'faststart'], cwd=bpath)
